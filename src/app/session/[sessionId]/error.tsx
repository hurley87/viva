...
// A Session id that is not the caller's own — a pasted link, a stale
// bookmark — makes the Convex read throw. That is an authorization failure,
// which throws by design; this turns it into a sentence rather than a stack.
